      ...
      <section className="bg-white py-16">
        <div className="w-11/12 max-w-6xl mx-auto px-4 md:px-8 pb-20">
          ...
          <div className="flex justify-center">
            <ul className="list-disc list-inside space-y-4 text-black text-base md:text-[20px] font-light marker:text-[8px] marker:text-black max-w-2xl pl-4 md:pl-0">
              {data.map((d, index) => (
        ...
        <div className="w-11/12 max-w-6xl mx-auto px-4 md:px-8">
          ...
          <div className="flex justify-center">
            <ul className="list-disc list-inside space-y-4 text-black text-base md:text-[18px] font-light list-disc pl-5 marker:text-black marker:text-[8px] md:pl-30 lg:pl-25">
              {data1.map((d, index) => (
